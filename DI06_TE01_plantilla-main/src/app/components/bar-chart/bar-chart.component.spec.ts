...
describe('BarChartComponent', () => {
  ...
  const fakeSubject = new BehaviorSubject<{ categoria: string; totalResults: number; }>({ categoria: 'general', totalResults: 0 });/*Inicializar variable*/
  ...
  it('Comprobamos si podemos ejecutar actualizarValoresChart', () => {
   ...
   const mockData = { categoria: 'general', totalResults: 5 };
